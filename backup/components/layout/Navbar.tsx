...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-white border-b border-gray-200 font-serif ">
      <div className="max-w-[1440px] mx-auto flex items-center justify-between px-6 md:px-8 py-1">
        ...
        <div className="hidden lg:flex items-center gap-6 text-[13px] text-gray-700">
          {categories.map((cat) => (
            <Link
              key={cat.name}
              href={cat.href}
