      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="relative group overflow-hidden rounded-xl bg-[#f8f7f5] flex items-center min-h-[500px]">
          ...
          <div className="relative z-10 p-12 max-w-md">
            ...
            <Link href={"/products"} className="bg-[#009341] rounded-sm text-white px-8 py-3 uppercase tracking-widest text-xs font-sans font-bold hover:bg-[#7cb140] transition-colors">
              See More
            </Link>
          </div>
        </div>
