...
export default function WorkshopDetail() {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#f8f9f1] text-[#283618] p-6 text-center">
        ...
        <p className="text-[#a98467] mb-8">
          We couldn't find the workshop details for "{currentSlug}".
        </p>
        <Link
          href="/workshops"
          className="bg-[#009341] text-white px-8 py-3 rounded-full font-bold shadow-lg hover:bg-[#7baf40] transition-all"
        >
          Return to Portal
        </Link>
      </div>
  ...
  return (
    <div className="min-h-screen lg:pt-20 text-[#283618] selection:bg-[#7baf40] selection:text-white pb-20">
      ...
      <div className="max-w-5xl mx-auto py-8 px-6">
        ...
        <div className="grid grid-cols-1  gap-16">
          ...
          <div className="lg:col-span-8">
            <h2 className="text-2xl italic font-serif text-gray-500 mb-8 leading-relaxed">
              "{post.subtitle}"
            </h2>

            <div className="prose prose-stone max-w-none">
              <p className="text-lg text-[#6c757d] leading-relaxed mb-4 first-letter:text-5xl first-letter:font-bold first-letter:text-[#009341] first-letter:mr-3 first-letter:float-left">
                {post.intro}
              </p>
    ...
    <h3 className="text-2xl font-serif font-bold text-[#283618] uppercase tracking-tight">
      {section.heading}
                  ...
                  {section.points && Array.isArray(section.points) && (
                    <div className="grid grid-cols-1 gap-4 text-base rounded-2xl px-4">
                      {section.points.map((point: string, pIdx: number) => (
                        ...
                        >
                          <CheckCircle2
                            className="text-[#009341] mt-1 flex-shrink-0"
                            size={20}
                          />
              ...
              {/* Closing Card */}
              {/* <div className="bg-[#009341] flex flex-col justify-center items-center p-10 rounded-xl text-center text-white mt-16 shadow-xl relative overflow-hidden">
             
                <p className="text-xl max-w-2xl font-serif italic mb-6 relative z-10">
                  {post.closing}
                </p>
            ...
            <div className="sticky top-28 space-y-8">
              <div className="bg-white p-8 rounded-3xl border border-[#e9edc9] shadow-sm">
                ...
                <div className="space-y-6">
                  ...
                  <MetaItem
                    icon={<MapPin size={20} />}
                    label="Venue"
                    value={post.location || "Indoors Global Store"}
                  />
                </div>
              ...
              <div className="p-8 rounded-3xl bg-gradient-to-br from-[#283618] to-[#009341] text-white">
                ...
                <p className="text-white/70 text-sm mb-6 leading-relaxed">
                  We are always looking for creators and educators to share
                  meaningful habits.
                </p>
                <Link
                  href="/contact"
                  className="text-white font-bold text-xs underline underline-offset-8 tracking-widest uppercase hover:text-[#7baf40] transition-colors"
                >
                  Contact Us
                </Link>
              </div>
...
const MetaItem = ({
  ...
  <div className="flex items-center gap-4">
    <div className="bg-[#f8f9f1] p-3 rounded-xl text-[#009341]">{icon}</div>
    <div>
