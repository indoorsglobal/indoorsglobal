...
const productsData = [
 ...
 { id: 10, name: "Bamboo Tongue Cleaner", img: bamboo_essentials10, category: "Bamboo Essentials" },
  ...
  // --- Cane Baskets ---
  { id: 11, name: "Boat Bag", img: cane_baskets1, category: "Cane Baskets" },
  { id: 12, name: "Storage Lid Box", img: cane_baskets2, category: "Cane Baskets" },
  { id: 13, name: "Beach Bag", img: cane_baskets3, category: "Cane Baskets" },
  { id: 14, name: "Shelf Basket", img: cane_baskets4, category: "Cane Baskets" },
  { id: 15, name: "Fruit Basket", img: cane_baskets5, category: "Cane Baskets" },
  { id: 16, name: "Hamper Bag", img: cane_baskets6, category: "Cane Baskets" },
  { id: 17, name: "Tiffin Bag", img: cane_baskets7, category: "Cane Baskets" },
  { id: 18, name: "Designer Jaali Bag", img: cane_baskets8, category: "Cane Baskets" },
  { id: 19, name: "Designer Boat Bag", img: cane_baskets9, category: "Cane Baskets" },

  // --- Rice Husk ---
  { id: 20, name: "Riged guard Loofah", img: rice_husk1, category: "Rice Husk" },
  { id: 21, name: "Bamboo Ear Swabs", img: rice_husk2, category: "Rice Husk" },
  { id: 22, name: "Canister", img: rice_husk3, category: "Rice Husk" },
  { id: 23, name: "Soup Bowl", img: rice_husk4, category: "Rice Husk" },
  { id: 24, name: "Classic Mug", img: rice_husk5, category: "Rice Husk" },
  { id: 25, name: "Canister (Tall)", img: rice_husk6, category: "Rice Husk" },
  { id: 26, name: "Snack plate", img: rice_husk7, category: "Rice Husk" },
  { id: 27, name: "Chai Cup", img: rice_husk8, category: "Rice Husk" },
  { id: 28, name: "Dinner Set", img: rice_husk9, category: "Rice Husk" },
