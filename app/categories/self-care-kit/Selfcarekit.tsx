...
export default function Selfcarekit() {
  // Is component ke liye default category "TOILETRY KIT" ya koi specific wellness category rakh sakte hain
  // Maine default "TOILETRY KIT" rakha hai, aap ise change bhi kar sakte hain
    ...
    <div className="max-w-7xl mx-auto px-4 py-12 bg-white font-sans">
      ...
      <header className="mb-10">
        <h1 className="text-3xl md:text-4xl font-serif font-bold text-gray-900 mb-2 uppercase tracking-tight">
          {activeCategory === "TOILETRY KIT" ? "Self-Care Kit" : activeCategory}
        </h1>
        <p className="text-gray-500 italic ">
          Sustainable Essentials for Your Personal Wellness
        </p>
      </header>
