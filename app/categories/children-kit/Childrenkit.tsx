...
import { CATEGORIES, ecoBundleProducts } from '@/data/ecoBundle'; // Sahi path check kar lein

export default function Childrenkit() {
  // Shuruat mein hum "CHILDREN KIT" ya pehli category dikha sakte hain
  const [activeCategory, setActiveCategory] = useState("CHILDREN KIT");
  const [viewMode, setViewMode] = useState<'grid' | 'list'>('grid');

  // Filter Logic using Imported Data
    ...
    <div className="max-w-7xl mx-auto px-4 py-12 bg-white font-sans">
      ...
      <div className={
        ...
        {filteredProducts.map((product) => {
          ...
          // Dynamic Category URL (slug friendly)
